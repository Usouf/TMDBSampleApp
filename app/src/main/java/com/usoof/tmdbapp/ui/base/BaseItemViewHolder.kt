...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    private fun buildViewHolderComponent(): ViewHolderComponent =
        DaggerViewHolderComponent.builder()
            .applicationComponent(((itemView.context.applicationContext) as TMDBApp).applicationComponent)
    ...
    abstract fun injectDependencies(viewHolderComponent: ViewHolderComponent)
